...
from towe.tools.utils import tprint, init_w2v_matrix
from towe.tools.TOWE_utils import load_text_target_label, split_dev, numericalize, numericalize_label
from towe.process.grapher import Grapher
...
class Processer():
    def __init__(self, data_path, word_emb_mode="w2v", build_graph=True, distance_gate=1):
        ...
        self.dev_data_path = os.path.join(data_path, dev_file_name)
    ...
    def load_data(self):
        ...
        dev_text, dev_t, dev_ow = load_text_target_label(self.dev_data_path)

...
class Config:
    ...
    def reset_config(self, args):
        ...
        if args.w2v_path:
            self.config_dicts['preprocess']['w2v_path'] = args.w2v_path
        if args.pretrained_bert_path:
            self.config_dicts['preprocess']['pretrained_bert_path'] = args.pretrained_bert_path
        if args.train_log:
            self.config_dicts['model']['train_log'] = args.train_log
        if args.val_log:
            self.config_dicts['model']['val_log'] = args.val_log
